//! Fetching an object from an ordered list of sources (RFC §14.5).
//!
...
//! The caller decides source order (peers ranked by `edge-cdn`, origin last).
...
/// Per-attempt results, for peer scoring and byte counters. Never used to
/// decide integrity.
