//! Canonical Tilecast Edge filesystem layout (RFC §7).
//!
//! ```text
...
//!     identity/                         0700: device-credential, node-key-*.pk8
...
//! fixed names; no path is ever built from a filename, URL or peer input.
