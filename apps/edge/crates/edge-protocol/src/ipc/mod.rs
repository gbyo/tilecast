...
//!
//! Device credentials, node private keys, Presentation Network secrets,
//! server-signed documents, arbitrary filesystem paths from a client,
...
pub enum Role {
    ...
    Tilecastctl,
    /// Reserved for a future user-session bridge (PipeWire, RFC §6.4).
