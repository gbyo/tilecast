...
//!   pin expiry, report timestamps. It is
...
//!
//! Ordering of server state never uses either clock: it uses the versions and
//! revisions the server assigns.
...
/// clock directly. Today the implementation is [`SystemClock`]; a corrected
/// clock can replace it behind the same trait.
...
mod tests {
    ...
    fn parses_offsets_and_formats_utc() {
        ...
        assert_eq!(fractional.to_string(), "2026-09-22T20:10:00.25Z");
