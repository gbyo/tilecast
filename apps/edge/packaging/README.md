...
> status and runs the peer fabric. It does not yet fetch the server manifest,
> run commands, or send the player heartbeat and socket presence. Studio
> shows a migrated screen as offline, and the screen does not play server
