...
This page is for the Linux Player Tilecast currently releases. **Tilecast Edge** is its replacement, but Edge is still being qualified on physical hardware. See [Tilecast Edge](../../edge/) for the current requirements and supported features.
:::
