...
:::caution[Not the production Linux install yet]
Tilecast does not currently ship Edge as the stable Linux Player. Use [Install Tilecast Player on Linux](../../players/install-linux/) for production screens.
:::
