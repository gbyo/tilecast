...
description: See how Tilecast Edge uses HDMI-CEC, DDC/CI, Presentation Network, and host audio for the Noise Meter, and how it reports what each Player can do.
---
